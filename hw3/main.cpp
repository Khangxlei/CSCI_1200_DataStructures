...
void StudentTests() {
  ...
  assert (a.numElementsInBin(3) == 1);
  assert (a.numElementsInBin(4) == 1);
  assert (a.getElement(1,0) == 4);
  assert (a.getElement(1,1) == 24);
  assert (a.getElement(4,0) == 12);
  assert (a.getElement(3,0) == 23);
  assert (a.getElement(1,2) == 41);
  a.clear();
  a.print();



  JaggedArray<std::string> khang(5);
  khang.addElement(1,"sd");
  khang.addElement(1, "k");
  khang.addElement(2, "ab");
  khang.addElement(4, "cd");
  khang.addElement(4, "ef");
  khang.addElement(4, "hi");
  khang.addElement(3, "gs");
  assert (khang.numElementsInBin(0) == 0);
  assert (khang.numElementsInBin(1) == 2);
  assert (khang.numElementsInBin(2) == 1);
  assert (khang.numElementsInBin(3) == 1);
  assert (khang.numElementsInBin(4) == 3);
  assert (khang.getElement(1,0) == "sd");
  assert (khang.getElement(1,1) == "k");
  assert (khang.getElement(2,0) == "ab");
  assert (khang.getElement(4,0) == "cd");
  assert (khang.getElement(4,1) == "ef");
  assert (khang.getElement(4,2) == "hi");
  assert (khang.getElement(3,0) == "gs");
  cout << endl;
  khang.print();
  khang.clear();
  khang.print();
